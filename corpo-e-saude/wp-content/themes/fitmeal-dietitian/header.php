							...
							<div class="col-lg-3 col-md-3 col-sm-3 col-8 align-self-center">
								<div class="logo">
							        <?php if ( has_custom_logo() ) : ?>
					            		<?php the_custom_logo(); ?>
						            <?php endif; ?>
					              	<?php $fitmeal_dietitian_blog_info = get_bloginfo( 'name' ); ?>
						                <?php if ( ! empty( $fitmeal_dietitian_blog_info ) ) : ?>
						                ...
						                <?php endif; ?>
						                <?php
					                  		$fitmeal_dietitian_description = get_bloginfo( 'description', 'display' );
						                  	if ( $fitmeal_dietitian_description || is_customize_preview() ) :
						                ?>
						                <?php if( get_option('nutrition_diet_logo_text','') != 'off' ){ ?>
					                  	<p class="site-description">
					                    	<?php echo esc_html($fitmeal_dietitian_description); ?>
					                  	</p>
					                  	<?php }?>
					              	<?php endif; ?>
							    </div>
