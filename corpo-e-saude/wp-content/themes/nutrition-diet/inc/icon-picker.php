...
class Nutrition_Diet_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'nutrition-diet' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $nutrition_diet_font_awesome_icon_array = nutrition_diet_font_awesome_icon_array();
                    foreach ($nutrition_diet_font_awesome_icon_array as $nutrition_diet_font_awesome_icon) {
                            $icon_class = $this->value() == $nutrition_diet_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($nutrition_diet_font_awesome_icon).'"></i>
                            <span class="nutrition-diet-social-class">'.esc_attr($nutrition_diet_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function nutrition_diet_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'nutrition-diet-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'nutrition_diet_customizer_script' );

if(!function_exists('nutrition_diet_font_awesome_icon_array')){
    function nutrition_diet_font_awesome_icon_array(){
